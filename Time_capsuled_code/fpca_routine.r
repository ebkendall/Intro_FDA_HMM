...
mcmc_routine = function( y, t, id, init_par, prior_par, par_index,
    ...
    for(ttt in 2:steps){
        ...
        log_post_prev = fn_log_post_continuous( pars, prior_par, par_index, y, id, EIDs, B_1_master, B_2_master)
        ...
        for(j in 1:n_group){
            ...
            log_post = fn_log_post_continuous(proposal, prior_par, par_index, y, id, EIDs, B_1_master, B_2_master)
